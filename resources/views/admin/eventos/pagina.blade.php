...
<div class="container-fluid">
    ...
    {{-- FORM --}}
    <form method="POST"
          action="{{ route('admin.pagina-eventos.update') }}"
        ...
        <div class="glass rounded-5 p-4 mb-4 shadow">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-12">
                    <label class="text-white">Subtítulo</label>
            ...
            <div class="row g-4">
                ...
                @foreach (['casamento', 'aniversario', 'formatura', 'corporativo'] as $tipo)
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="{{ $tipo }}_texto"
                                  class="form-control"
                                  rows="3">{{ old($tipo . '_texto', $pagina->{$tipo . '_texto'}) }}</textarea>
                    </div>
            ...
            <div class="row g-4">
                ...
                @for ($i = 1; $i <= 4; $i++)
                    ...
                    <div class="col-md-3">
                        ...
                        <label class="text-white">Foto {{ $i }}</label>
        ...
        <div class="glass rounded-5 p-4 mb-4 shadow">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <label class="text-white">Título</label>
                    <input name="diferenciais_titulo"
                           class="form-control"
        ...
        <div class="glass rounded-5 p-4 mb-4 shadow">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <label class="text-white">Título</label>
                    <input name="cta_titulo"
                           class="form-control"
                           value="{{ old('cta_titulo', $pagina->cta_titulo) }}">
                </div>

                <div class="col-md-6">
                    <label class="text-white">Botão</label>
                    <input name="cta_botao"
                           class="form-control"
                           value="{{ old('cta_botao', $pagina->cta_botao) }}">
                </div>

                <div class="col-md-12">
                    <label class="text-white">Texto</label>
                    <textarea name="cta_texto"
                              class="form-control"
                              rows="3">{{ old('cta_texto', $pagina->cta_texto) }}</textarea>
                </div>
